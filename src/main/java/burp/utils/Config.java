...
public class Config {
    ...
    public static final String ANTENNA_TOKEN = "antenna_token";

    public static final String ANTENNA_ROOT_DOMAIN = "antenna_root_domain";
    public static final String ANTENNA_REST_API =  "antenna_rest_api";
    ...
    public static final String PROXY_POOL_ENABLED = "proxy_pool_enabled";
    public static final String PROXY_POOL_TEXT = "proxy_pool_text";
